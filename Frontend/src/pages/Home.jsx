...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post(
      "https://ddgpt-4eog.onrender.com/api/chat",
      {
        title,
      },
      {
  ...
  useEffect(() => {
    axios
      .get("https://ddgpt-4eog.onrender.com/api/chat", {
        withCredentials: true,
      })
      .then((response) => {
    ...
    const tempSocket = io("https://ddgpt-4eog.onrender.com", {
      withCredentials: true,
    });
  ...
  const getMessages = async (chatId) => {
    const response = await axios.get(
      `https://ddgpt-4eog.onrender.com/api/chat/messages/${chatId}`,
      { withCredentials: true }
    );
